from honeybee_schema.radiance.modifier import (
    Plastic,
    Glass,
    BSDF,
    Glow,
...
def test_modifier_plastic_black():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Plastic.model_validate_json(json_data)
...
def test_modifier_metal():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Metal.model_validate_json(json_data)
...
def test_glass_generic_exterior_window():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Glass.model_validate_json(json_data)


def test_glass_air_boundary():
    file_path = os.path.join(target_folder, "modifier_glass_air_boundary.json")
    # Glass.parse_file(file_path)
    with open(file_path) as file:
        json_data = file.read()
    Glass.model_validate_json(json_data)
...
def test_mirror_typical():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Mirror.model_validate_json(json_data)
...
def test_bsdf_klemsfull():
    ...
    with open(file_path) as file:
        json_data = file.read()
    BSDF.model_validate_json(json_data)
...
def test_modifier_glow_white():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Glow.model_validate_json(json_data)
...
def test_modifier_light_green_spotlight():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Light.model_validate_json(json_data)
...
def test_trans_tree_foliage():
    ...
    with open(file_path) as file:
        json_data = file.read()
    Trans.model_validate_json(json_data)
