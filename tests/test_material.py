from honeybee_schema.energy.material import (
    EnergyMaterial,
...
def test_material_opaque_gypsum():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyMaterial.model_validate_json(json_data)
...
def test_material_opaque_wall_gap():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyMaterialNoMass.model_validate_json(json_data)
...
def material_window_glazing_clear():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialGlazing.model_validate_json(json_data)
...
def test_material_window_blind():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialBlind.model_validate_json(json_data)
...
def test_material_window_gas():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialGas.model_validate_json(json_data)
...
def test_material_window_gas_mixture():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialGasMixture.model_validate_json(json_data)
...
def test_material_window_gas_custom():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialGasCustom.model_validate_json(json_data)
...
def test_material_window_glazing_system():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialSimpleGlazSys.model_validate_json(json_data)
...
def test_material_window_shade():
    ...
    with open(file_path) as file:
        json_data = file.read()
    EnergyWindowMaterialShade.model_validate_json(json_data)
...
def test_material_wrong():
    ...
    with pytest.raises(ValidationError):
        EnergyMaterial.model_validate(wrong_name)
