from honeybee_schema.energy.schedule import (
...
def test_ruleset_office_occupancy():
    file_path = os.path.join(target_folder, "schedule_ruleset_office_occupancy.json")
    # ScheduleRulesetAbridged.parse_file(file_path)
    with open(file_path) as file:
        json_data = file.read()
    ScheduleRulesetAbridged.model_validate_json(json_data)
...
def test_ruleset_simple_repeating():
    file_path = os.path.join(target_folder, "schedule_ruleset_simple_repeating.json")
    # ScheduleRulesetAbridged.parse_file(file_path)
    with open(file_path) as file:
        json_data = file.read()
    ScheduleRulesetAbridged.model_validate_json(json_data)
...
def test_fixedinterval_increasing_single_day():
    ...
    with open(file_path) as file:
        json_data = file.read()
    ScheduleFixedIntervalAbridged.model_validate_json(json_data)
...
def test_fixedinterval_random_annual():
    file_path = os.path.join(target_folder, "schedule_fixedinterval_random_annual.json")
    # ScheduleFixedIntervalAbridged.parse_file(file_path)
    with open(file_path) as file:
        json_data = file.read()
    ScheduleFixedIntervalAbridged.model_validate_json(json_data)
...
def test_fixedinterval_leap_year():
    file_path = os.path.join(target_folder, "schedule_fixedinterval_leap_year.json")
    # ScheduleFixedIntervalAbridged.parse_file(file_path)
    with open(file_path) as file:
        json_data = file.read()
    ScheduleFixedIntervalAbridged.model_validate_json(json_data)
