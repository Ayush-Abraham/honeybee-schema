...
class HorizontalElementShading(AbstractBase):
    ...
    eave_horizontal_element_shading: Optional[EaveHorizontalElementShading] = Field(
        default=None,
        metadata={
    ...
    pergola_horizontal_element_shading: Optional[PergolaHorizontalElementShading] = (
        Field(
            default=None,
            metadata={
...
class FloorCeiling(AbstractInternalElement):
    ...
    infiltration_penetrations: Optional[ArrayOfInfiltrationPenetration] = Field(
        default=None,
        metadata={
