...
class Sensor(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^Sensor$")] = "Sensor"
...
class SensorGrid(_RadianceAsset):
    ...
    type: Annotated[str, StringConstraints(pattern="^SensorGrid$")] = "SensorGrid"
...
class View(_RadianceAsset):
    ...
    type: Annotated[str, StringConstraints(pattern="^View$")] = "View"
