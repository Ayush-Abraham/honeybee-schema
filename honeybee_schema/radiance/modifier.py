...
from pydantic import field_validator, StringConstraints, Field, BaseModel
...
class Void(BaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^Void$")] = "Void"


class ModifierBase(IDdRadianceBaseModel):
    """Base class for Radiance Modifiers"""

    type: Annotated[str, StringConstraints(pattern="^ModifierBase$")] = "ModifierBase"


class Mirror(ModifierBase):
    """Radiance mirror material."""

    type: Annotated[str, StringConstraints(pattern="^Mirror$")] = "Mirror"

    modifier: Optional[_REFERENCE_UNION_MODIFIERS] = Field(
        default=Void(), description="Material modifier."
    )

    dependencies: List[_REFERENCE_UNION_MODIFIERS] | None = Field(
        default=None,
    ...
    alternate_material: _REFERENCE_UNION_MODIFIERS | None = Field(
        default=None,
...
class Plastic(ModifierBase):
    ...
    type: Annotated[str, StringConstraints(pattern="^Plastic$")] = "Plastic"
...
class Metal(Plastic):
    ...
    type: Annotated[str, StringConstraints(pattern="^Metal$")] = "Metal"
...
class Trans(Plastic):
    ...
    type: Annotated[str, StringConstraints(pattern="^Trans$")] = "Trans"
...
class Glass(ModifierBase):
    ...
    type: Annotated[str, StringConstraints(pattern="^Glass$")] = "Glass"
...
class BSDF(ModifierBase):
    ...
    type: Annotated[str, StringConstraints(pattern="^BSDF$")] = "BSDF"
    ...
    front_diffuse_reflectance: List[float] | None = Field(
        default=None,
        min_length=3,
        max_length=3,
    ...
    back_diffuse_reflectance: List[float] | None = Field(
        default=None,
        min_length=3,
        max_length=3,
    ...
    diffuse_transmittance: List[float] | None = Field(
        default=None,
        min_length=3,
        max_length=3,
...
class Light(ModifierBase):
    ...
    type: Annotated[str, StringConstraints(pattern="^Light$")] = "Light"
...
class Glow(Light):
    ...
    type: Annotated[str, StringConstraints(pattern="^Glow$")] = "Glow"
...
_REFERENCE_UNION_MODIFIERS = Union[
    Plastic, Glass, BSDF, Glow, Light, Trans, Metal, Void, Mirror
]
