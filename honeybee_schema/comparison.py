...
class ChangedObject(_DiffObjectBase):
    type: Annotated[str, StringConstraints(pattern="^ChangedObject$")] = "ChangedObject"
...
class DeletedObject(_DiffObjectBase):
    type: Annotated[str, StringConstraints(pattern="^DeletedObject$")] = "DeletedObject"
...
class AddedObject(_DiffObjectBase):
    type: Annotated[str, StringConstraints(pattern="^AddedObject$")] = "AddedObject"
