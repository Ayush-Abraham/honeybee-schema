...
from pydantic import field_validator, StringConstraints, Field, model_validator
...
class SimulationOutput(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^SimulationOutput$")] = (
        "SimulationOutput"
    )
...
class SimulationControl(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^SimulationControl$")] = (
        "SimulationControl"
    )
...
class ShadowCalculation(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^ShadowCalculation$")] = (
        "ShadowCalculation"
    )
...
class DaylightSavingTime(DatedBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^DaylightSavingTime$")] = (
        "DaylightSavingTime"
    )
...
class RunPeriod(DatedBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^RunPeriod$")] = "RunPeriod"
...
class SizingParameter(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^SizingParameter$")] = (
        "SizingParameter"
    )
...
class SimulationParameter(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^SimulationParameter$")] = (
        "SimulationParameter"
    )
