...
class IdealAirSystemAbridged(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^IdealAirSystemAbridged$")] = (
    ...
    heating_limit: Autosize | NoLimit | Annotated[float, Field(ge=0)] = Field(
        Autosize(),
    ...
    heating_availability: str | None = Field(
        None,
        min_length=1,
        max_length=100,
    ...
    cooling_availability: str | None = Field(
        None,
        min_length=1,
        max_length=100,
        description="An optional identifier of a schedule to set the availability of "
    ...
    def check_heating_temp_gt_cooling_temp(self):
        "Ensure that the heating_air_temperature > cooling_air_temperature."
        heat_temp = self.heating_air_temperature
        cool_temp = self.cooling_air_temperature
        assert heat_temp > cool_temp, (
