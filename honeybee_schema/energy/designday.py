...
class DryBulbCondition(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^DryBulbCondition$")] = (
        "DryBulbCondition"
    )
...
class HumidityCondition(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^HumidityCondition$")] = (
        "HumidityCondition"
    )
    ...
    rain: bool = Field(
        default=False, description="Boolean to indicate rain on the design day."
    )
...
class WindCondition(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^WindCondition$")] = "WindCondition"

    wind_speed: float = Field(
        ..., ge=0, le=40, description="Wind speed on the design day [m/s]."
    )

    wind_direction: float = Field(
        0, ge=0, le=360, description="Wind direction on the design day [degrees]."
    )
...
class ASHRAEClearSky(_SkyCondition):
    ...
    type: Annotated[str, StringConstraints(pattern="^ASHRAEClearSky$")] = (
        "ASHRAEClearSky"
    )
...
class ASHRAETau(_SkyCondition):
    ...
    type: Annotated[str, StringConstraints(pattern="^ASHRAETau$")] = "ASHRAETau"
...
class DesignDay(NoExtraBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^DesignDay$")] = "DesignDay"
