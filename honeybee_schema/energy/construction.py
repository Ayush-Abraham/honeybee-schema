...
class OpaqueConstructionAbridged(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^OpaqueConstructionAbridged$")] = (
        "OpaqueConstructionAbridged"
    )

    materials: List[Annotated[str, StringConstraints(min_length=1, max_length=100)]] = (
        Field(
            ...,
...
class OpaqueConstruction(OpaqueConstructionAbridged):
    ...
    type: Annotated[str, StringConstraints(pattern="^OpaqueConstruction$")] = (
        "OpaqueConstruction"
    )
...
class WindowConstructionAbridged(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^WindowConstructionAbridged$")] = (
...
class WindowConstruction(WindowConstructionAbridged):
    ...
    type: Annotated[str, StringConstraints(pattern="^WindowConstruction$")] = (
        "WindowConstruction"
    )
    ...
    frame: EnergyWindowFrame | None = Field(
        None,
...
class WindowConstructionShadeAbridged(IDdEnergyBaseModel):
    ...
    type: Annotated[
        str, StringConstraints(pattern="^WindowConstructionShadeAbridged$")
...
class WindowConstructionShade(WindowConstructionShadeAbridged):
    ...
    type: Annotated[str, StringConstraints(pattern="^WindowConstructionShade$")] = (
...
class WindowConstructionDynamicAbridged(IDdEnergyBaseModel):
    ...
    type: Annotated[
        str, StringConstraints(pattern="^WindowConstructionDynamicAbridged$")
...
class WindowConstructionDynamic(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^WindowConstructionDynamic$")] = (
...
class ShadeConstruction(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^ShadeConstruction$")] = (
        "ShadeConstruction"
    )
...
class AirBoundaryConstructionAbridged(IDdEnergyBaseModel):
    ...
    type: Annotated[
        str, StringConstraints(pattern="^AirBoundaryConstructionAbridged$")
    ...
    air_mixing_schedule: str | None = Field(
        default=None,
        min_length=1,
        max_length=100,
...
class AirBoundaryConstruction(AirBoundaryConstructionAbridged):
    ...
    type: Annotated[str, StringConstraints(pattern="^AirBoundaryConstruction$")] = (
