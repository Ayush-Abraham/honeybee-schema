...
class EnergyMaterialNoMass(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyMaterialNoMass$")] = (
...
class EnergyMaterial(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyMaterial$")] = (
        "EnergyMaterial"
    )
    ...
    thickness: float = Field(
        ..., gt=0, le=3, description="Thickness of the material layer in meters."
    )
    ...
    density: float = Field(
        ..., gt=0, description="Density of the material layer in kg/m3."
    )

    specific_heat: float = Field(
        ..., ge=100, description="Specific heat of the material layer in J/kg-K."
    )
...
class EnergyMaterialVegetation(IDdEnergyBaseModel):
    ...
    thickness: float = Field(
        0.1, gt=0, le=3, description="Thickness of the soil layer in meters."
    )
    ...
    density: float = Field(1100, gt=0, description="Density of the dry soil in kg/m3.")

    specific_heat: float = Field(
        1200, ge=100, description="Specific heat of the dry soil in J/kg-K."
    )
...
class EnergyWindowMaterialSimpleGlazSys(IDdEnergyBaseModel):
    ...
    # type: constr(regex="^EnergyWindowMaterialSimpleGlazSys$") = "EnergyWindowMaterialSimpleGlazSys"
    type: Annotated[
        str, StringConstraints(pattern="^EnergyWindowMaterialSimpleGlazSys$")
...
class EnergyWindowMaterialGlazing(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyWindowMaterialGlazing$")] = (
    ...
    infrared_transmittance: float = Field(
        0, ge=0, le=1, description="Long-wave transmittance at normal incidence."
    )
...
class EnergyWindowFrame(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyWindowFrame$")] = (
        "EnergyWindowFrame"
    )
...
class EnergyWindowMaterialGas(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyWindowMaterialGas$")] = (
...
class EnergyWindowMaterialGasMixture(IDdEnergyBaseModel):
    ...
    # type: constr(regex="^EnergyWindowMaterialGasMixture$") = "EnergyWindowMaterialGasMixture"
    type: Annotated[
        str, StringConstraints(pattern="^EnergyWindowMaterialGasMixture$")
    ] = "EnergyWindowMaterialGasMixture"

    thickness: float = Field(
        0.0125, gt=0, description="The thickness of the gas mixture layer in meters."
    )

    gas_types: List[GasType] = Field(
        ..., min_length=2, max_length=4, description="List of gases in the gas mixture."
    )
    ...
    def check_types_fractions_match(self):
        "Ensure the gas types and fractions match."
        gas_types = self.gas_types
        gas_fractions = self.gas_fractions
        assert len(gas_types) == len(gas_fractions), (
            "Length of gas_types must match length of gas_fractions. {} != {}".format(
...
class EnergyWindowMaterialGasCustom(IDdEnergyBaseModel):
    ...
    # type: constr(regex="^EnergyWindowMaterialGasCustom$") = "EnergyWindowMaterialGasCustom"
    type: Annotated[
        str, StringConstraints(pattern="^EnergyWindowMaterialGasCustom$")
    ...
    conductivity_coeff_b: float = Field(
        0, description="The B coefficient for gas conductivity in W/(m-K2)."
    )

    conductivity_coeff_c: float = Field(
        0, description="The C coefficient for gas conductivity in W/(m-K3)."
    )

    viscosity_coeff_a: float = Field(
        ..., gt=0, description="The A coefficient for gas viscosity in kg/(m-s)."
    )

    viscosity_coeff_b: float = Field(
        0, description="The B coefficient for gas viscosity in kg/(m-s-K)."
    )

    viscosity_coeff_c: float = Field(
        0, description="The C coefficient for gas viscosity in kg/(m-s-K2)."
    )

    specific_heat_coeff_a: float = Field(
        ..., gt=0, description="The A coefficient for gas specific heat in J/(kg-K)."
    )

    specific_heat_coeff_b: float = Field(
        0, description="The B coefficient for gas specific heat in J/(kg-K2)."
    )

    specific_heat_coeff_c: float = Field(
        0, description="The C coefficient for gas specific heat in J/(kg-K3)."
    )

    specific_heat_ratio: float = Field(
        ..., gt=1, description="The specific heat ratio for gas."
    )

    molecular_weight: float = Field(
        ..., ge=20, le=200, description="The molecular weight for gas in g/mol."
    )
...
class EnergyWindowMaterialShade(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyWindowMaterialShade$")] = (
...
class EnergyWindowMaterialBlind(IDdEnergyBaseModel):
    ...
    type: Annotated[str, StringConstraints(pattern="^EnergyWindowMaterialBlind$")] = (
